...
import { handleFileUpload, createExcelFromImeis } from "@/utils/file-handlers";
...
export const ClientForm: FC<ClientFormProps> = ({ order }) => {
            ...
            try {
                ...
                const updatedOrder: IOrder = {
                    ...
                    Account: {
                        ...
                        Personal: values.is_business ? null : {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>, uploadFunction: (file: File) => Promise<string>, fieldName: keyof ClientFormData) => {
                    ...
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                                ...
                                <TabsContent value="personal" className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-3 gap-y-2 gap-x-4">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-xs text-muted-foreground">RUT</FormLabel>
                                                    <FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-xs text-muted-foreground">Apellidos</FormLabel>
                                                    <FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-xs text-muted-foreground">Nacionalidad</FormLabel>
                                                    <FormControl>
                                        ...
                                        <div className="space-y-1.5">
                                            <Label className="text-xs text-muted-foreground">Carnet de Identidad</Label>
                                            <Input
                                                type="file"
                                                accept="image/*,.pdf"
                                                onChange={(e) => handleFileChange(e, uploadPersonalUserIdCard, "id_card_url")}
                                            />
                                        </div>

                                        <div className="space-y-1.5">
                                            <Label className="text-xs text-muted-foreground">Comprobante de Compra</Label>
                                            <Input
                                                type="file"
                                                accept="image/*,.pdf"
                                                onChange={(e) => handleFileChange(e, uploadPersonalPurchaseReceipt, "purchase_receipt_url")}
                                            />
                                        </div>
                                    </div>
                                </TabsContent>
                                ...
                                <TabsContent value="business" className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-xs text-muted-foreground">Nombre de la Empresa</FormLabel>
                                                    <FormControl>
                                        ...
                                        <div className="space-y-1.5">
                                            <Label className="text-xs text-muted-foreground">Comprobante de Importación</Label>
                                            <Input
                                                type="file"
                                                accept="image/*,.pdf"
                                                onChange={(e) => handleFileChange(e, uploadBusinessImportReceipt, "import_receipt_url")}
                                            />
                                        </div>
                                    </div>
                                </TabsContent>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-3 gap-x-4 gap-y-2">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground">Monto Total</FormLabel>
                                            <FormControl>
                                                <Input
                                                    type="number"
                                                    placeholder="0"
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground">Estado de Pago</FormLabel>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground">Número de Compra</FormLabel>
                                            <FormControl>
                        ...
                        <DialogFooter>
                            ...
                            <Button
                                ...
                                className="gap-2"
                            >
                                {(isPending || fileUploading) && <Loader className="h-4 w-4 animate-spin" />}
